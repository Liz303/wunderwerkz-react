      ...
      <span>
       ...
       <div className="show-phone flex-wrapper center">
         ...
         <div className="logo-wrap">
           <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" x="0px" y="0px" width="100%" height="auto" viewBox="0 225.957 1024 319.543" enable-background="new 0 225.957 1024 319.543">
             ...
             <polygon className="z-slash" fill="#231F20" points="498.85,322.045 495.342,317.251 417.758,227.286 389.067,227.286 498.85,353.394 "/>
             ...
             <polygon className="z-slash" fill="#231F20" points="687.946,537.393 712.073,537.557 806.481,412.492 782.354,412.41 "/>
         ...
         <div>
           <p>
           For the full site experience, view on desktop.
          </p>
        </div>
         <div className="info-group flex-wrapper">
           ...
           <p className="four-fifths">
             <a href="https://www.google.com/maps/place/3515+Ringsby+Ct,+Denver,+CO+80216/@39.7733508,-104.9828953,17z/data=!3m1!4b1!4m5!3m4!1s0x876c7903ec2bc8b1:0x5782fe9631c8fd61!8m2!3d39.7733508!4d-104.9807066?sa=X&ved=0ahUKEwitgtycvITWAhVT6Z8KHRlVA5EQ8gEIJzAA"
                className="center">
               3515 Ringsby Ct #308 DENVER, CO 80216
             </a>
           </p>
         </div>
         <div className="info-group flex-wrapper">
